...
class Geothermal_Custom:
    ...
    def __init__(self, timer, n_points, min_p, max_p, min_e, max_e, property_container, mass_rate=False):
        """"
        ...
        engine_name = eval("engine_nce_cpu%d" % (self.n_components))
        ...
        try:
            ...
            self.acc_flux_itor = acc_flux_itor_name_long(self.acc_flux_etor, index_vector([n_points, n_points]),
                                                         value_vector([min_p, min_e]), value_vector([max_p, max_e]))
            self.acc_flux_itor_well = acc_flux_itor_name_long(self.acc_flux_etor_well,
                                                              index_vector([n_points, n_points]),
                                                              value_vector([min_p, min_e]),
                                                              value_vector([max_p, max_e]))
